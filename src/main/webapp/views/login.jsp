        ...
        <div class="row justify-content-center">
          <div class="col-lg-5">
            <div class="card shadow-lg border-0 rounded-lg mt-5">
              ...
              <div class="card-body">
                <form id="formLogin" action="<c:url value="/dang-nhap?action=login"/> " method="post">
                  ...
                  <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                    ...
                    <button class="btn btn-primary" type="submit" id="loginBtnSubmit">Login </button>
<%--                    must be in form tag--%>
...
<script>
    $(function (){
        ...
        $('#loginBtnSubmit').onclick(function () {
